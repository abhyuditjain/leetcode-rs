...
mod tests {
    ...
    #[test]
    fn test_atoi_positive_leading_space() {
        assert_eq!(atoi("   42"), 42);
    }

    #[test]
    fn test_atoi_positive_leading_space_plus_sign() {
        assert_eq!(atoi("   +42"), 42);
    }

    #[test]
    fn test_atoi_negative_leading_space() {
        assert_eq!(atoi("   -42"), -42);
    }

    #[test]
    fn test_atoi_positive_with_words() {
        assert_eq!(atoi("4193 with words"), 4193);
    }

    #[test]
    fn test_atoi_negative_with_words() {
        assert_eq!(atoi("-4193 with words"), -4193);
    }
}
